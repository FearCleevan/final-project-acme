        ...
        <div className="space-y-8 mb-14">
          {[
            ...
            },
            {
              ...
              body: 'Orders are dispatched within 2–4 business days of payment confirmation. You will receive a tracking number by email when your parcel is collected by the carrier. Dispatch times may be slightly longer during peak periods.',
            },
            {
              title: 'International customs & duties',
              body: 'We declare all items at their full invoice value. We do not falsify customs declarations. Import duties and taxes are the responsibility of the buyer. These are not collected by us at checkout and vary by country — please check your local customs rules before ordering.',
            },
            {
              title: 'Damaged in transit',
              body: 'If your order arrives damaged, please photograph it in the packaging before removing the item, then contact us at acmesign01@gmail.com. Transit damage claims must be made directly with the freight carrier. We will provide any invoices, photos, or documentation required to support your claim.',
            },
          ].map(({ title, body }) => (
