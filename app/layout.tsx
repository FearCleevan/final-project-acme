...
const SITE_URL =
  process.env.NEXT_PUBLIC_SITE_URL ?? "https://www.acmevintagesupply.com";
...
const jsonLd = {
  ...
  hasOfferCatalog: {
    ...
    description:
      "Oil lamp chimneys, shades, pressure lamp glass, wicks, burners, and original Victorian enamel advertising signs. Each piece bench-inspected before dispatch.",
  },
  sameAs: [],
};
      ...
      style={
        {
          ...
          "--font-sans":
            "var(--font-inter), system-ui, -apple-system, Arial, sans-serif",
          "--font-mono":
